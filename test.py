...
if __name__ == '__main__':
    ...
    if args.compute:
        for m in models_to_be_computed['recorder']:
            ...
            model.accuracy(wygiwyu=True, update_self_testing=not args.dry_run, print_results='TFR')
            model.ood_detection_rates(wygiwyu=True, update_self_testing=not args.dry_run, print_results='OFR')
